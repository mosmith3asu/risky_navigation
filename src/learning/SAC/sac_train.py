...
def main(layout, MAX_EPIS = 3_000):
    ...
    # OG Config
    agent_config = {  }
    # load_fname = r"\2026-01-24_01-54-19_SACAgent_AVE_spath"
    # agent_config['loads'] =  r'D:\PycharmProjects\risky_navigation\src\learning\SAC\models' + load_fname
    ...
    ############ AVE AGENT ##############
    # agent_config['note'] = 'new rshape + norm'
    # agent_config['randstart_sched'] = (1.0, 0.75, 250)
    # agent_config['rshape_sched'] = (1.0, 1.0, 1000)
    # agent = SACAgent_AVE(env, **agent_config)

    ############ CPT AGENT ##############
    cpt_params = cpt_rational

    # agent_config['note'] = 'new rshap + lame'
    #
    ...
    #
    # agent_config['loads'] = r"D:\PycharmProjects\risky_navigation\src\learning\SAC\models\2026-01-21_18-29-20_SACAgent_AVE_spath"
    # agent_config['loads'] = r"D:\PycharmProjects\risky_navigation\src\learning\SAC\models\2026-01-24_01-54-19_SACAgent_AVE_spath"
    #
    #
    #
    # cpt_params = {
